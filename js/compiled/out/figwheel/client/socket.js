...
}catch (e32667){if((e32667 instanceof Error)){
var e = e32667;
return null;
} else {
throw e32667;
...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__32668){
var map__32669 = p__32668;
var map__32669__$1 = ((((!((map__32669 == null)))?(((((map__32669.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__32669.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__32669):map__32669);
var opts = map__32669__$1;
var retry_count = cljs.core.get.call(null,map__32669__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
var retried_count = cljs.core.get.call(null,map__32669__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var websocket_url = cljs.core.get.call(null,map__32669__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var build_id = cljs.core.get.call(null,map__32669__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
...
socket.onmessage = ((function (url,socket,WebSocket,temp__5455__auto__,map__32669,map__32669__$1,opts,retry_count,retried_count,websocket_url,build_id){
...
});})(url,socket,WebSocket,temp__5455__auto__,map__32669,map__32669__$1,opts,retry_count,retried_count,websocket_url,build_id))
;

socket.onopen = ((function (url,socket,WebSocket,temp__5455__auto__,map__32669,map__32669__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__5455__auto__,map__32669,map__32669__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__5455__auto__,map__32669,map__32669__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__5455__auto__,map__32669,map__32669__$1,opts,retry_count,retried_count,websocket_url,build_id))
...
socket.onerror = ((function (url,socket,WebSocket,temp__5455__auto__,map__32669,map__32669__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
//# sourceMappingURL=socket.js.map?rel=1545274393462
