...
var o26588 = temp__5455__auto__;
var temp__5455__auto____$1 = (o26588["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o26589 = temp__5455__auto____$1;
return (o26589["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__25700__auto__ = f;
return (o__25700__auto__["toString"]).call(o__25700__auto__);
} else {
return "";
}
}catch (e26590){var _ = e26590;
return "";
}});
...
try{var o__25700__auto___26592 = t;
(o__25700__auto___26592["cljs$lang$ctorPrWriter"]).call(o__25700__auto___26592,t,writer);
}catch (e26591){var __26593 = e26591;
}
...
var char_code = (function (){var o__25700__auto__ = (new String(char$));
return (o__25700__auto__["charCodeAt"]).call(o__25700__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__25700__auto__ = String;
return (o__25700__auto__["fromCharCode"]).call(o__25700__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__26594 = num_code;
switch (G__26594) {
case (1):
return (185);
...
var o__25700__auto__ = String;
return (o__25700__auto__["fromCharCode"]).call(o__25700__auto__,superscript_code);
});
/**
...
}catch (e26596){var _e__25707__auto__ = e26596;
return false;
}})())){
...
var vec__26597 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__26597,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o26600 = temp__5455__auto__;
var temp__5455__auto____$1 = (o26600["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o26601 = temp__5455__auto____$1;
return (o26601["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__26604){
var vec__26605 = p__26604;
var ns_detector = cljs.core.nth.call(null,vec__26605,(0),null);
...
var G__26611 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__26612 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__26611;
remaining_tokens = G__26612;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq26602){
var G__26603 = cljs.core.first.call(null,seq26602);
var seq26602__$1 = cljs.core.next.call(null,seq26602);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26603,seq26602__$1);
});
...
var vec__26616 = cljs.core.split_with.call(null,(function (p1__26615_SHARP_){
return cljs.core.not_EQ_.call(null,p1__26615_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__26616,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__26616,(1),null);
...
var vec__26619 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__26619,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__26619,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__26622 = cljs.core.rest.call(null,remaining_tokens);
var G__26623 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__26622;
name_tokens = G__26623;
continue;
} else {
...
var vec__26626 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__26626,(0),null);
var arity = cljs.core.nth.call(null,vec__26626,(1),null);
var vec__26629 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__26629,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__26629,(1),null);
var vec__26632 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__26632,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__26632,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__26632,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__26632,(3),null);
...
var vec__26638 = result;
var munged_ns = cljs.core.nth.call(null,vec__26638,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__26638,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__26638,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__26638,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__26638,(4),null);
var arity = cljs.core.nth.call(null,vec__26638,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__26642 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__26642,(0),null);
var args = cljs.core.nth.call(null,vec__26642,(1),null);
var vec__26645 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__26645,(0),null);
var name = cljs.core.nth.call(null,vec__26645,(1),null);
...
var G__26648 = (arity + (1));
var G__26649 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__26650){
var vec__26651 = p__26650;
var arity = cljs.core.nth.call(null,vec__26651,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__26651,(1),null);
...
return cljs.core.get.call(null,arities,p1__26654_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__26655_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__26658){
var vec__26659 = p__26658;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__26659,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq26656){
var G__26657 = cljs.core.first.call(null,seq26656);
var seq26656__$1 = cljs.core.next.call(null,seq26656);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26657,seq26656__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__26667__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__26667__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__26667__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__26667__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__26668 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__26668,(0),null);
var fn_name = cljs.core.nth.call(null,vec__26668,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__26668,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__26668,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__26668,(4),null);
var arity = cljs.core.nth.call(null,vec__26668,(5),null);
...
var o__25700__auto__ = f;
return (o__25700__auto__["getBasis"]).call(o__25700__auto__);
});
/**
...
}catch (e26672){var _e__25707__auto__ = e26672;
...
var G__26673 = (obj[cljs.core.first.call(null,path)]);
var G__26674 = cljs.core.rest.call(null,path);
obj = G__26673;
path = G__26674;
continue;
} else {
...
return (function (accum,p__26675){
var vec__26676 = p__26675;
var bit = cljs.core.nth.call(null,vec__26676,(0),null);
var protocol = cljs.core.nth.call(null,vec__26676,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__26679){
var vec__26680 = p__26679;
var ns = cljs.core.nth.call(null,vec__26680,(0),null);
var name = cljs.core.nth.call(null,vec__26680,(1),null);
var selector = cljs.core.nth.call(null,vec__26680,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__26685,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__26685,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__26685,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__26683_SHARP_){
return (obj[cljs.core.first.call(null,p1__26683_SHARP_)]);
});})(name,sorted_matches,vec__26685,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1545274385506
