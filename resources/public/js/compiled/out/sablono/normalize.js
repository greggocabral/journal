...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__21895){
var vec__21896 = p__21895;
var _ = cljs.core.nth.call(null,vec__21896,(0),null);
...
if(((((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$)))) && (cljs.core.every_QMARK_.call(null,(function (p1__21899_SHARP_){
return (((p1__21899_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__21899_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.call(null,G__21900,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__21900;
}
});
...
var len__4499__auto___21903 = arguments.length;
var i__4500__auto___21904 = (0);
while(true){
if((i__4500__auto___21904 < len__4499__auto___21903)){
args__4502__auto__.push((arguments[i__4500__auto___21904]));

var G__21905 = (i__4500__auto___21904 + (1));
i__4500__auto___21904 = G__21905;
continue;
} else {
}
break;
...
var G__21902 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes))){
return cljs.core.assoc.call(null,G__21902,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__21902;
}
} else {
...
/** @this {Function} */
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq21901){
...
var vec__21908 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__21908,(0),null);
var names = cljs.core.nth.call(null,vec__21908,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,((function (matches,vec__21908,tag_name,names){
return (function (p1__21906_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__21906_SHARP_))){
return p1__21906_SHARP_;
} else {
return null;
}
});})(matches,vec__21908,tag_name,names))
,names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,((function (matches,vec__21908,tag_name,names){
return (function (p1__21907_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__21907_SHARP_));
});})(matches,vec__21908,tag_name,names))
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__21911){
var vec__21912 = p__21911;
var seq__21913 = cljs.core.seq.call(null,vec__21912);
var first__21914 = cljs.core.first.call(null,seq__21913);
var seq__21913__$1 = cljs.core.next.call(null,seq__21913);
var tag = first__21914;
var content = seq__21913__$1;
...
var vec__21915 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__21915,(0),null);
var id = cljs.core.nth.call(null,vec__21915,(1),null);
var class$ = cljs.core.nth.call(null,vec__21915,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1545274382803
