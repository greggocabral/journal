...
return (new CustomEvent(event_name,(function (){var obj31062 = {"detail":data};
return obj31062;
})()));
} else {
...
var f = (function (){var pred__31069 = cljs.core._EQ_;
var expr__31070 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__31069.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__31070))){
return ((function (pred__31069,expr__31070){
return (function (p1__31063_SHARP_){
return console.warn(p1__31063_SHARP_);
});
;})(pred__31069,expr__31070))
} else {
if(cljs.core.truth_(pred__31069.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__31070))){
return ((function (pred__31069,expr__31070){
return (function (p1__31064_SHARP_){
return console.debug(p1__31064_SHARP_);
});
;})(pred__31069,expr__31070))
} else {
if(cljs.core.truth_(pred__31069.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__31070))){
return ((function (pred__31069,expr__31070){
return (function (p1__31065_SHARP_){
return console.error(p1__31065_SHARP_);
});
;})(pred__31069,expr__31070))
} else {
return ((function (pred__31069,expr__31070){
return (function (p1__31066_SHARP_){
return console.log(p1__31066_SHARP_);
});
;})(pred__31069,expr__31070))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__31073){
...
var eval_fn = cljs.core.get.call(null,map__31074__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__31076_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__31078,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1545274391468
